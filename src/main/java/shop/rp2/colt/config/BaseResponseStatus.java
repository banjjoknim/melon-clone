...
public enum BaseResponseStatus {
    ...
    SUCCESS_POST_LIKED_ON_MUSIC(true, 1003, "곡 좋아요에 성공하였습니다."),
    ...
    SUCCESS_POST_LIKED_ON_ALBUM(true, 1014, "앨범 좋아요에 성공하였습니다."),
    SUCCESS_DELETE_LIKED_ON_ALBUM(true, 1015, "앨범 좋아요 취소에 성공하였습니다."),
    ...
    FAILED_TO_POST_MUSIC(false, 2001, "곡 생성에 실패했습니다. 입력값을 확인해주세요."),
    FAILED_TO_POST_ALBUM(false, 2002, "앨범 생성에 실패했습니다. 입력값을 확인해주세요."),
    ...
    FAILED_TO_POST_MUSIC_REPLY(false, 3006, "내용을 입력하지 않았습니다."),
    FAILED_TO_PUT_MUSIC_REPLY(false, 3007, "수정 권한이 없습니다."),
    FAILED_TO_DELETE_MUSIC_REPLY(false, 3008, "삭제 권한이 없습니다."),
